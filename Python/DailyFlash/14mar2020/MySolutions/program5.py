'''
Write a Program that computes Area of a triangle if user enters the
vertices of all three points of that triangle.
{Steps:
1. Calculate Area of Triangle using Heron’s Formula i.e. Area A of
triangle is :
A = √p(p-a)(p-b)(p-c)
Where,
- a, b & c are the distances/lengths of each side of triangle.
